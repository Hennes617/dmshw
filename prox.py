...
<body>
    ...
    <script>
        ...
        function findBestMatchingNode(userLat, userLon, nodes, referenceTemp, tempTolerance = 1) {
        ...
        async function loadWeatherData() {
            ...
            try {
                ...
                if (referenceTemp !== null && referenceTemp !== undefined) {
                    selectedNodeResult = findBestMatchingNode(userLat, userLon, nodes, referenceTemp, 1);
                } else {
